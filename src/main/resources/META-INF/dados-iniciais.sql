insert into aluno(id, situacao, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (1, "ATIVO", "Estação", "Felype", "Lapa", "07565617964", "caio@gmail.com", "Rua Carlos Pedro", "Caio de Fernando de Abreu e Souza Alburquerque", "145645", "M", "PR", true);
insert into aluno(id, situacao, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (2, "AGUARDANDO", "Lacerda", "Felype", "Lapa", "123456789", "pedro@gmail.com", "Rua Carlos Pedro", "Pedro", "123456", "M", "PR", true);
insert into aluno(id, situacao, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (3, "ATIVO", "Souza Naves", "Felype", "Lapa", "222222222", "eduarda@gmail.com", "Rua Carlos Pedro", "Eduarda", "22222", "F", "PR", true);
insert into aluno(id, situacao, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (4, "INATIVO", "Vila do Principe", "Felype", "Lapa", "333333333", "bruno@gmail.com", "Rua Carlos Pedro", "Bruno", "3333", "M", "PR", false);
insert into aluno(id, situacao, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (5, "AGUARDANDO", "Pinheirinho", "Felype", "Curitiba", "444444444", "camile@gmail.com", "Rua Carlos Pedro", "Camile", "4444", "F", "PR", false);
insert into aluno(id) values (10);
insert into responsavel(id, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (6, "Lugar Nenhum", "Felype", "Lapa", "223423", "paula@gmail.com", "Rua Carlos Antonio", "Paula de Fatima Souza e Filha", "424", "F", "PR", true);
insert into responsavel(id, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (7, "Los Verejos", "Felype", "Whashinton", "23423", "caska@gmail.com", "Rua Novo Pedro", "Caska das árvores maiores", "5345", "F", "PR", true);
insert into responsavel(id, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (8, "Aldeia da Folha", "Felype", "São Paulo", "53453", "camile@gmail.com", "Rua Carlos Pereiras", "Chritian de Oliveira Pereiras", "242", "M", "PR", false);
insert into responsavel(id, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf, send_email) values (9, "Vila Nova Fibrurgo", "Felype", "Petrolina", "444444444", "camile@gmail.com", "Rua Bermudas", "Triangulo das Bermudas", "34234", "M", "PR", true);
