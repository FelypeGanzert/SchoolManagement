...
insert into pessoa(id, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf) values (7, "Los Verejos", "Felype", "Whashinton", "23423", "caska@gmail.com", "Rua Novo Pedro", "Caska das árvores maiores", "5345", "F", "PR");
insert into pessoa(id, bairro, cadastrado_por, cidade, cpf, email, endereco, nome, rg, sexo, uf) values (8, "Aldeia da Folha", "Felype", "São Paulo", "53453", "camile@gmail.com", "Rua Carlos Pereiras", "Chritian de Oliveira Pereiras", "242", "M", "PR");
